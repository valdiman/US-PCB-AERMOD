...
# Select the nearest major station (KLMAZO/BTL CREEK INTL ARPT)
# kar.station <- stations[stations$usaf == "726357", ]
...
# NOAA station IDs
usaf <- as.character(kar.station$usaf[1])
wban <- as.character(kar.station$wban[1])
